<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <div class="navbar-brand-box" style="margin: auto 0">
                ...
                <a href="{{ route('dashboard') }}" class="logo logo-light">
                    <span class="logo-sm text-light">
                        <i class="fab fa-shopify" style="font-size: 1.5em"></i>
                    </span>
                    <span class="logo-lg text-light">
                        <i class="fab fa-shopify" style="font-size: 1.5em"></i>&nbsp; TOKO SAHABAT
                    </span>
                </a>
            </div>
