...
@section('title')
Tambah Pembayaran | Toko Sahabat
@endsection
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Tambah Pembayaran</h4>
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('add.payment') }}" method="POST" id="add-payment-form">
                                @csrf

                                <div class="row mb-3">
                                    <label for="payment_method" class="col-sm-4 col-form-label">Metode Pembayaran</label>
                                    <div class="form-group col-sm-8">
                                        <input class="form-control" name="payment_method" type="text" placeholder="" id="payment_method">
                                ...
                                <input class="btn btn-success btn-sm mt-2" type="submit" value="Tambah Pembayaran">
                            </form>
